...
When creating a pipeline, you can specify its intended **Deployment Targets**. This helps organize and authorize how your RAG pipeline is consumed across your ecosystem.

Jabrod supports the following targets:
