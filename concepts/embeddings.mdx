...
|-------|------------|----------|------|-------|
| `text-embedding-3-small` | 1536 | OpenAI | Free / Pro | Fast, cheap, industry standard. |
| `nomic-embed-text` | 768 | Nomic | Free / Pro | Open source alternative. |
| `text-embedding-3-large` | 3072 | OpenAI | Pro | Higher precision for complex queries. |
| `cohere/embed-english-v3.0`| 1024 | Cohere | Pro | Excellent for English RAG. |
| `voyage/voyage-large-2` | 1536 | Voyage | Pro | State-of-the-art retrieval performance. |
